---
name: news-impact
description: Phân tích tác động tin tức lên cổ phiếu Việt Nam — sentiment, catalyst, rủi ro sự kiện
triggers:
  - "tin tức"
  - "news"
  - "tin tức cổ phiếu"
...
```
get_stock_news(symbol, days=7)         → tin liên quan 7 ngày gần nhất
get_company_events(symbol)             → lịch sự kiện: ĐHCĐ, trả cổ tức, phát hành
get_market_news(category="macro")      → tin vĩ mô VN: lãi suất, tỷ giá, GDP
search_news(query="{symbol} site:cafef.vn OR vietstock.vn")
```
